...
<div id="header2">&nbsp;Docklands Light Railway Challenge</div>
<?php
	...
	<h3>&nbsp;</h3>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>  
					...
					<?php
					$query = "SELECT * FROM tc_challenge WHERE tc_challenge = 'D40'";
...
<h3>Current Configuration</h3>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D40' ORDER BY tc_hours, tc_mins, tc_sec";
...
<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D3E' ORDER BY tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
...
<p>Between December 2007 and June 2008 the first of two short-term interim configurations existed - this one was 39 stations with the opening of Langdon Park, but before the closure of Tower Gateway.</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D39' ORDER BY tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
...
<p>Until December 2007 there was no station at Langdon Park, and a separate record existed for this configuration.</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D38' ORDER BY tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
