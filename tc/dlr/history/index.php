...
<div id="header2">&nbsp;DLR Challenge History</div>
...
<p>Since March 2009 (40 stations)</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D40' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
...
<p>June 2008-March 209 (38 stations, Tower Gateway closed)</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				<tr class="newshead">  
					<td width="80">Broken on</td>
					<td>By</td>
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D3E' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
				...
				<?php	$prevhr = $fncdata['tc_hours'];
					...
					<td><i><?php $diff = (date("U", mktime(0,0,0,3,7,2009)) - $prevdate)/86400; echo round($diff); ?> days</i></td>
				</tr>
			</table>
<p>December 2007-June 2008 (39 Stations)</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				<tr class="newshead">  
					<td width="80">Broken on</td>
					<td>By</td>
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D39' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
				...
				<?php	$prevhr = $fncdata['tc_hours'];
					...
					<td><i><?php $diff = (date("U", mktime(0,0,0,7,22,2008)) - $prevdate)/86400; echo round($diff); ?> days</i></td>
				</tr>
			</table>
<p>Until December 2007 (38 Stations)</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				<tr class="newshead">  
					<td width="80">Broken on</td>
					<td>By</td>
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'D38' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
				...
				<?php	$prevhr = $fncdata['tc_hours'];
					...
					<td><i><?php $diff = (date("U", mktime(0,0,0,2,9,2008)) - $prevdate)/86400; echo round($diff); ?> days</i></td>
				</tr>
			</table>
