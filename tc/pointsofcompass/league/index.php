...
<div id="header2">&nbsp;Points of the Compass Challenge</div>
<?php
	...
	<h3>&nbsp;</h3>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>  
					...
					<?php
					$query = "SELECT * FROM tc_challenge WHERE tc_challenge = 'POC'";
			...
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'POC' ORDER BY tc_hours, tc_mins, tc_sec";
