<?php
	...
	$query = "SELECT tc_challenge, tc_challenge_name FROM tc_challenge WHERE tc_uri = '$challenge' LIMIT 1";
...
?>
				...
				<tr>
					...
					<td class="row1" width="100"><?php if($details['tc_station_count']) {echo $details['tc_station_count'];} else {echo "n/a";} ?></td>
					<td class="row1">&nbsp;</td>
				</tr>
				<tr>
