...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>
		<div id="temps">Page generated at: <?php echo date("H:i"); ?>,&nbsp;<?php echo date("d.m.y"); ?>&nbsp;[<a class="text" href="javascript:location.reload()">refresh?</a>]&nbsp;</div>
		<div id="header1">&nbsp;Tube Challenge League Tables - UNDER CONSTRUCTION!!</div>
		<div id="header2">Challengers&nbsp;</div>
<?php include('../menu.php'); ?>
		...
		<div id="content">
			...
			<p>If you find your name spelt incorrectly, or a team name where you were a member, please <a href="mailto:tube@scriv.me.uk">get in touch</a> with the details!</p>
			<form method="get" align= "center" action="/challengers/results.php">
				<input type="text" name="name" size="50" maxlength="50" value=""><input type="submit" value="Search">
			</form>
