...
?>
		<div id="content">
		<p>From the data held, the following can statistics can be gleaned:<br />This page doesn't seem to display as desired. It *will* be fixed...</p>
...
<?php
	$query = "SELECT count(tc_challenge) as no, tc_challenge FROM `tc_data` group by tc_challenge order by no desc limit 1";
	$fnc = mysql_query($query) or die("Select Failed! [400]"); 					
	$fncdata = mysql_fetch_array($fnc); $maxreturn = $fncdata['no'];
?>
			<table class="stats" align="center" border="0" cellpadding="0" cellspacing="1">
			...
			<p>This page will likely grow and grow as I think of more things to add. Suggestions? Email <a href="mailto:tube@scriv.me.uk?subject=Statistics">tube&#64;scriv.me.uk</a>.</p>
		</div>
	</body>
</html>