...
<div id="header2">&nbsp;Snake Challenge History</div>
...
<p>The following table shows only times which broke the existing record when they were set, and as such is an account of the evolution of the record over time.</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'SK2' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
...
<h3>Previous configuration</h3>			
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'SNK' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
				...
				<?php	$prevhr = $fncdata['tc_hours'];
					...
					<td><i><?php $diff = (date("U", mktime(0,0,0,7,24,2009)) - $prevdate)/86400; echo round($diff); ?> days</i></td>
				</tr>
			</table>
