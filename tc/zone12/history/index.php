...
<div id="header2">&nbsp;Zones 1 &amp; 2 Challenge History</div>
...
<p>This list may be inaccurate whilst dates remain missing from the data.</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'Z12' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
