...
<div id="header2">&nbsp;South London Challenge</div>
<?php
	...
	<h3>&nbsp;</h3>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>  
					...
					<?php
					$query = "SELECT * FROM tc_challenge WHERE tc_challenge = 'S29'";
			...
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'S29' ORDER BY tc_hours, tc_mins, tc_sec";
...
<p>Until December 2007 the East London Line formed part of the London Underground Network, and until it's removal, the South London Challenge included Wapping, Surrey Quays, New Cross &amp; New Cross Gate.</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'S33' ORDER BY tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
