...
<div id="header2">&nbsp;South London Challenge History</div>
<?php
...
<p>Since December 2007</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php					
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'S29' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
...
<p>Until December 2007</p>
			<table align="center" border="0" cellpadding="1" cellspacing="0">
				...
				<?php	mysql_pconnect("localhost","Mcrivpro","password")
					...
					$query = "SELECT * FROM tc_data WHERE tc_challenge = 'S33' AND tc_date is not null ORDER BY tc_date, tc_hours, tc_mins, tc_sec";
					$fnc = mysql_query($query) or die("Select Failed! [302]");
				...
				<?php	$prevhr = $fncdata['tc_hours'];
					...
					<td><i><?php $diff = (date("U", mktime(0,0,0,5,29,2008)) - $prevdate)/86400; echo round($diff); ?> days</i></td>
				</tr>
			</table>
